...
namespace ColorBorder
{
    ...
    class Program
    {
        ...
        private static bool EnumWindowsProcId(IntPtr hWnd, int lParam)
        {
            ...
            //Graphics g2 = Graphics.FromHdc(hdcDesktop);

            //Pen p1 = new Pen(System.Drawing.Color.Orange, 100);

           
            //Rectangle Rec1 = new Rectangle(0, 0, width, 50);
            
            //g2.DrawString("HELLO WORLD", new Font("Tahoma", 20), Brushes.Black, Rec1);
            //g2.DrawRectangle(p1, Rec1);
            ////g2.FillEllipse(Brushes.Red, 0, 0, 400, 400);
            //p1.Dispose();
            //g2.Dispose();
